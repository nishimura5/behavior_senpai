...
import keypoints_to_band as k2b
...
class App(ttk.Frame):
    ...
    def __init__(self, master):
        ...
        # keypoints_to_bandのボタン
        k2b_button = ttk.Button(buttons_frame, text="keypoints_to_band.py", command=lambda: self.launch_window(k2b.App), width=26)
