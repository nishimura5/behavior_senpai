...
class Annotate:
    ...
    def draw(self):
        ...
        img_draw.draw_line(self.dst_img, self.left_shoulder, self.right_shoulder, self.line_color, 1)
        ...
        img_draw.draw_line(self.dst_img, self.left_hip, self.right_hip, self.line_color, 1)
