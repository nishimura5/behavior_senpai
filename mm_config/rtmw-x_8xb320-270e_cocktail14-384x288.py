...
# codec settings
codec = dict(
    type="SimCCLabel", input_size=input_size, sigma=(6.0, 6.93), simcc_split_ratio=2.0, normalize=False, use_dark=False, decode_visibility=True
)
...
halpe_coco133 = [(i, i) for i in range(17)] + [(20, 17), (21, 20), (22, 18), (23, 21), (24, 19), (25, 22)] + [(i, i - 3) for i in range(26, 136)]
